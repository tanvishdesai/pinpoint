...
class StandardCrossAttentionBlock(nn.Module):
    ...
    def forward(self, audio_feat, video_feat, video_mask=None):
        ...
        final_output = audio_feat + self.dropout(cross_attn_output)
...
class PinpointTransformer(nn.Module):
    def __init__(self, config):
        ...
        self.attention_layers = nn.ModuleList([StandardCrossAttentionBlock(config.EMBED_DIM, config.NUM_HEADS, config.DROPOUT) for _ in range(config.NUM_LAYERS)])
        ...
        print("PinpointTransformer model initialized (Standard Cross-Attention variant).")
...
# =================================================================================
# =================================================================================
# NEW: LIME (LOCAL INTERPRETABLE MODEL-AGNOSTIC EXPLANATIONS)
# =================================================================================
class LIMEExplainer:
    """
    ...
    def register_attention_hooks(self):
        ...
        def attention_hook(module, input, output):
            if hasattr(module, 'audio_to_video_attn'):
                # This is a StandardCrossAttentionBlock 
        ...
        for name, module in self.model.named_modules():
            if isinstance(module, StandardCrossAttentionBlock ):
...
# =================================================================================
# NEW: OCCLUSION SENSITIVITY EXPLAINER (PROBABILITY-BASED)
# =================================================================================
